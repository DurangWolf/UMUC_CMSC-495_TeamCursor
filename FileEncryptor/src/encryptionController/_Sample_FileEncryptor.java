...
//Example found at: http://stackoverflow.com/questions/13673556/using-password-based-encryption-on-a-file-in-java
...
public class _Sample_FileEncryptor {
...
/*    public static void main( String[] args ) {
    ...
    private static Cipher makeCipher(String pass, Boolean decryptMode) throws GeneralSecurityException{
        ...
        _Sample_FileEncryptor.keyToFile(key);
    ...
    public static void encryptFile(String fileName, String pass)
        ...
        Cipher cipher = _Sample_FileEncryptor.makeCipher(pass, true);
    ...
    public static void decryptFile(String fileName, String pass)
        ...
        //Generate the cipher using pass:
        Cipher cipher = _Sample_FileEncryptor.makeCipher(pass, false);
