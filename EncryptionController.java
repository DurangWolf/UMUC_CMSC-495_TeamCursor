...
public class EncryptionController {
	...
	public static void main(String[] args){
		KeyManagement kc = new KeyManagement("Test.txt", "User1 password");
		KeyManagement kc2 = new KeyManagement("Test2.txt", "User2 password");
		KeyManagement kc3 = new KeyManagement("Test3.txt", "User3 password");
		KeyManagement kc4 = new KeyManagement("Test4.txt", "User4 password");
		kc.searchForValueFromKey("Test.txt");
